    ...
    return Scaffold(
      ...
      endDrawer:   Drawer(
        ...
        child: ListView(
          ...
          children: [
            ListTile(title: Text("Jane doe", style: TextStyle(
                color: Colors.black,
            ...
            ListTile(
              title: Text("Discover People", style: TextStyle(
                  color: Colors.black,
                  fontSize: Dimensions.fontSizeLarge,
                  fontWeight: FontWeight.w500),),
            ),
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: CustomButton(title: "Edit Profile", onTap: (){
          ...
          const Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Icon(Icons.dashboard_sharp, color: Color(0xfff1cb0b),size: 40,),
              Icon(Icons.favorite_border_outlined, color: Color(0xfff1cb0b),size: 40),
              Icon(Icons.lock_outline, color: Color(0xfff1cb0b),size: 40,)
            ],
          )
        ],
      ),
